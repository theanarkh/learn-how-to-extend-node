...
const char* kBuiltinName_316(compiler::CodeAssemblerState* state_) {
...
compiler::TNode<Number> FindIndexAllElements_317(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSTypedArray, HeapObject, Object, Number> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, JSTypedArray, HeapObject, Object, Number> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp194);
    tmp194 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, -1);
...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp57);
    tmp57 = FindIndexAllElements_317(state_, compiler::TNode<Context>{tmp49}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<HeapObject>{tmp54}, compiler::TNode<Object>{tmp56});
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_316(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_316(state_));
  }
}
