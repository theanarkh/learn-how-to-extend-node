...
TorqueStructGrowableFixedArray NewGrowableFixedArray_277(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp0);
    tmp0 = kEmptyFixedArray_187(state_);
    compiler::TNode<IntPtrT> tmp1;
    USE(tmp1);
    tmp1 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 0);
