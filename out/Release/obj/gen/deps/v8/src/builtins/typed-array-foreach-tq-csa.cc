...
const char* kBuiltinName_318(compiler::CodeAssemblerState* state_) {
...
compiler::TNode<Object> ForEachAllElements_319(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSTypedArray, HeapObject, Object, Object> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp160);
    tmp160 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 1);
  ...
  return compiler::TNode<Object>{tmp181};
}
...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp57);
    tmp57 = ForEachAllElements_319(state_, compiler::TNode<Context>{tmp49}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<HeapObject>{tmp54}, compiler::TNode<Object>{tmp56});
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_318(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_318(state_));
  }
}
