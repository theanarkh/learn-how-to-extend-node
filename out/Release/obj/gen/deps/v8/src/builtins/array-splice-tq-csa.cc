...
compiler::TNode<FixedDoubleArray> Extract16FixedDoubleArray_43(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_first, compiler::TNode<Smi> p_count, compiler::TNode<Smi> p_capacity) {
  ...
  if (block2.is_used()) {
    ...
    USE(tmp12);
    tmp12 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp11});
  ...
  if (block3.is_used()) {
    ...
    USE(tmp20);
    tmp20 = UnsafeCast16FixedDoubleArray_1372(state_, compiler::TNode<Context>{tmp14}, compiler::TNode<Object>{tmp19});
...
compiler::TNode<Object> FastArraySplice_44(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, TorqueStructArguments p_args, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_originalLengthNumber, compiler::TNode<Number> p_actualStartNumber, compiler::TNode<Smi> p_insertCount, compiler::TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block0.is_used()) {
    ...
    tmp9 = Cast5ATSmi_79(state_, compiler::TNode<Object>{tmp5}, &label0);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp31);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp31 = Cast5ATSmi_79(state_, compiler::TNode<Object>{tmp26}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp55);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp55 = Cast5ATSmi_79(state_, compiler::TNode<Object>{tmp51}, &label0);
  ...
  if (block7.is_used()) {
    ...
    USE(tmp83);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp83 = Cast7JSArray_94(state_, compiler::TNode<HeapObject>{tmp72}, &label0);
  ...
  if (block20.is_used()) {
    ...
    USE(tmp289);
    tmp289 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 2);
  ...
  if (block28.is_used()) {
    ...
    USE(tmp372);
    tmp372 = UnsafeCast10HeapObject_1377(state_, compiler::TNode<Context>{tmp352}, compiler::TNode<Object>{tmp371});
  ...
  if (block30.is_used()) {
    ...
    USE(tmp395);
    tmp395 = AllowDoubleElements_192(state_, compiler::TNode<Int32T>{tmp390});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 139);
  ...
  if (block31.is_used()) {
    ...
    USE(tmp417);
    tmp417 = AllowNonNumberElements_193(state_, compiler::TNode<Int32T>{tmp412});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 139);
  ...
  if (block36.is_used()) {
    ...
    USE(tmp545);
    tmp545 = AllowNonNumberElements_193(state_, compiler::TNode<Int32T>{tmp541});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 144);
  ...
  if (block24.is_used()) {
    ...
    USE(tmp625);
    tmp625 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 1);
  ...
  if (block22.is_used()) {
    ...
    USE(tmp646);
    tmp646 = ElementsKindNotEqual_73(state_, compiler::TNode<Int32T>{tmp643}, compiler::TNode<Int32T>{tmp644});
  ...
  if (block38.is_used()) {
    ...
    USE(tmp665);
    tmp665 = Convert7ATint3214ATElementsKind_146(state_, compiler::TNode<Int32T>{tmp663});
    compiler::TNode<Smi> tmp666;
    USE(tmp666);
    tmp666 = Convert5ATSmi7ATint32_150(state_, compiler::TNode<Int32T>{tmp665});
  ...
  if (block39.is_used()) {
    ...
    USE(tmp688);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp688 = Cast5ATSmi_79(state_, compiler::TNode<Object>{tmp687}, &label0);
  ...
  if (block43.is_used()) {
    ...
    USE(tmp768);
    tmp768 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 0);
  ...
  if (block44.is_used()) {
    ...
    USE(tmp791);
    tmp791 = kEmptyFixedArray_187(state_);
    ...
    USE(tmp793);
    tmp793 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 0);
  ...
  if (block46.is_used()) {
    ...
    FastSplice10FixedArray20UT5ATSmi10HeapObject_1393(state_, compiler::TNode<Context>{tmp815}, TorqueStructArguments{compiler::TNode<RawPtrT>{tmp816}, compiler::TNode<RawPtrT>{tmp817}, compiler::TNode<IntPtrT>{tmp818}}, compiler::TNode<JSArray>{tmp829}, compiler::TNode<Smi>{tmp833}, compiler::TNode<Smi>{tmp828}, compiler::TNode<Smi>{tmp825}, compiler::TNode<Smi>{tmp822}, compiler::TNode<Smi>{tmp826});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 168);
  ...
  if (block47.is_used()) {
    ...
    FastSplice16FixedDoubleArray20UT5ATSmi10HeapNumber_1394(state_, compiler::TNode<Context>{tmp835}, TorqueStructArguments{compiler::TNode<RawPtrT>{tmp836}, compiler::TNode<RawPtrT>{tmp837}, compiler::TNode<IntPtrT>{tmp838}}, compiler::TNode<JSArray>{tmp849}, compiler::TNode<Smi>{tmp853}, compiler::TNode<Smi>{tmp848}, compiler::TNode<Smi>{tmp845}, compiler::TNode<Smi>{tmp842}, compiler::TNode<Smi>{tmp846});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 168);
...
compiler::TNode<Object> FillDeletedElementsArray_45(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_actualStart, compiler::TNode<Number> p_actualDeleteCount, compiler::TNode<JSReceiver> p_a) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Number> tmp5;
    USE(tmp5);
    tmp5 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 0);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp56);
    tmp56 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
...
void HandleForwardCase_46(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<Number> p_itemCount, compiler::TNode<Number> p_actualStart, compiler::TNode<Number> p_actualDeleteCount) {
  ...
  if (block8.is_used()) {
    ...
    compiler::TNode<Smi> tmp66;
    USE(tmp66);
    tmp66 = FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_141(state_, LanguageMode::kStrict);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp78);
    tmp78 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
    compiler::TNode<Number> tmp79;
    USE(tmp79);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp121);
    tmp121 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
    ...
    USE(tmp123);
    tmp123 = FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_141(state_, LanguageMode::kStrict);
    ...
    compiler::TNode<Number> tmp125;
    USE(tmp125);
    tmp125 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
...
void HandleBackwardCase_47(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<Number> p_itemCount, compiler::TNode<Number> p_actualStart, compiler::TNode<Number> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    compiler::TNode<Number> tmp40;
    USE(tmp40);
    tmp40 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
    compiler::TNode<Number> tmp41;
    USE(tmp41);
    ...
    compiler::TNode<Number> tmp43;
    USE(tmp43);
    tmp43 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
    compiler::TNode<Number> tmp44;
    USE(tmp44);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp70);
    tmp70 = FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_141(state_, LanguageMode::kStrict);
    compiler::TNode<Object> tmp71;
  ...
  if (block9.is_used()) {
    ...
    compiler::TNode<Number> tmp82;
    USE(tmp82);
    tmp82 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
    compiler::TNode<Number> tmp83;
    USE(tmp83);
...
compiler::TNode<Object> SlowSplice_48(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, TorqueStructArguments p_arguments, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<Number> p_actualStart, compiler::TNode<Smi> p_insertCount, compiler::TNode<Number> p_actualDeleteCount) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 305);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 308);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 320);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 324);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 328);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 333);
    compiler::TNode<IntPtrT> tmp118;
    USE(tmp118);
    tmp118 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 2);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp132);
    tmp132 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 2);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 335);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 337);
    CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, tmp147, tmp151, tmp158, tmp160);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 340);
    compiler::TNode<Number> tmp162;
    USE(tmp162);
    tmp162 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 1);
  ...
  if (block16.is_used()) {
    ...
    USE(tmp177);
    tmp177 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 1);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 346);
    compiler::TNode<String> tmp204;
    USE(tmp204);
    tmp204 = kLengthString_70(state_);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 348);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 356);
    compiler::TNode<JSReceiver> tmp5;
    tmp5 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kToObject, tmp3, tmp4));
    USE(tmp5);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 359);
    compiler::TNode<Number> tmp6;
    USE(tmp6);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 363);
    compiler::TNode<Number> tmp9;
    USE(tmp9);
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Number> tmp42;
    USE(tmp42);
    tmp42 = Max_77(state_, compiler::TNode<Number>{tmp40}, compiler::TNode<Number>{tmp41});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 368);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 370);
    compiler::TNode<Number> tmp52;
    USE(tmp52);
    tmp52 = Min_76(state_, compiler::TNode<Number>{tmp51}, compiler::TNode<Number>{tmp49});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 368);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 373);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 375);
    compiler::TNode<IntPtrT> tmp73;
    USE(tmp73);
    tmp73 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 0);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 377);
    compiler::TNode<Smi> tmp87;
    USE(tmp87);
    tmp87 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 0);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 379);
    compiler::TNode<Number> tmp88;
    USE(tmp88);
    tmp88 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 0);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 375);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 381);
    compiler::TNode<IntPtrT> tmp101;
    USE(tmp101);
    tmp101 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 1);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 383);
    compiler::TNode<Smi> tmp115;
    USE(tmp115);
    tmp115 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 0);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 385);
    compiler::TNode<Number> tmp116;
    USE(tmp116);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 389);
    compiler::TNode<Smi> tmp129;
    USE(tmp129);
    tmp129 = Convert5ATSmi8ATintptr_158(state_, compiler::TNode<IntPtrT>{tmp119});
    compiler::TNode<Smi> tmp130;
    USE(tmp130);
    tmp130 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 2);
    compiler::TNode<Smi> tmp131;
    USE(tmp131);
    ...
    compiler::TNode<IntPtrT> tmp132;
    USE(tmp132);
    tmp132 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 1);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 392);
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 394);
    compiler::TNode<Number> tmp135;
    USE(tmp135);
    tmp135 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_133(state_, 0);
    compiler::TNode<Number> tmp136;
    USE(tmp136);
    tmp136 = Max_77(state_, compiler::TNode<Number>{tmp134}, compiler::TNode<Number>{tmp135});
    compiler::TNode<Number> tmp137;
    USE(tmp137);
    tmp137 = CodeStubAssembler(state_).NumberSub(compiler::TNode<Number>{tmp123}, compiler::TNode<Number>{tmp126});
    compiler::TNode<Number> tmp138;
    USE(tmp138);
    tmp138 = Min_76(state_, compiler::TNode<Number>{tmp136}, compiler::TNode<Number>{tmp137});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 387);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 381);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp165);
    tmp165 = FromConstexpr20UT5ATSmi10HeapNumber19ATconstexpr_float64_132(state_, kMaxSafeInteger);
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label1(&ca_);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 401);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 407);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 415);
...
void FastSplice10FixedArray20UT5ATSmi10HeapObject_1393(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, TorqueStructArguments p_args, compiler::TNode<JSArray> p_a, compiler::TNode<Smi> p_length, compiler::TNode<Smi> p_newLength, compiler::TNode<Smi> p_actualStart, compiler::TNode<Smi> p_insertCount, compiler::TNode<Smi> p_actualDeleteCount) {
  ...
  if (block0.is_used()) {
    ...
    EnsureWriteableFastElements_51(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<JSArray>{tmp4});
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    tmp42 = UnsafeCast10FixedArray_1370(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 68);
    DoMoveElements10FixedArray_1437(state_, compiler::TNode<FixedArray>{tmp42}, compiler::TNode<Smi>{tmp39}, compiler::TNode<Smi>{tmp40}, compiler::TNode<Smi>{tmp41});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 71);
    compiler::TNode<FixedArray> tmp43;
    USE(tmp43);
    tmp43 = UnsafeCast10FixedArray_1370(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 70);
    StoreHoles10FixedArray_1438(state_, compiler::TNode<FixedArray>{tmp43}, compiler::TNode<Smi>{tmp34}, compiler::TNode<Smi>{tmp33});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 66);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp90);
    tmp90 = UnsafeCast10FixedArray_1370(state_, compiler::TNode<Context>{tmp76}, compiler::TNode<Object>{tmp86});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 75);
    DoMoveElements10FixedArray_1437(state_, compiler::TNode<FixedArray>{tmp90}, compiler::TNode<Smi>{tmp87}, compiler::TNode<Smi>{tmp88}, compiler::TNode<Smi>{tmp89});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 74);
  ...
  if (block10.is_used()) {
    ...
    compiler::TNode<Smi> tmp111;
    USE(tmp111);
    tmp111 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 0);
  ...
  if (block12.is_used()) {
    ...
    USE(tmp129);
    tmp129 = UnsafeCast10FixedArray_1370(state_, compiler::TNode<Context>{tmp113}, compiler::TNode<Object>{tmp123});
    ...
    DoCopyElements10FixedArray_1439(state_, compiler::TNode<FixedArray>{tmp128}, compiler::TNode<Smi>{tmp124}, compiler::TNode<FixedArray>{tmp129}, compiler::TNode<Smi>{tmp125}, compiler::TNode<Smi>{tmp126});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 83);
  ...
  if (block3.is_used()) {
    ...
    compiler::TNode<Smi> tmp198;
    USE(tmp198);
    tmp198 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 0);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp213);
    tmp213 = UnsafeCast10FixedArray_1370(state_, compiler::TNode<Context>{tmp200}, compiler::TNode<Object>{tmp212});
    ...
    USE(tmp214);
    tmp214 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 2);
  ...
  if (block16.is_used()) {
    ...
    USE(tmp243);
    tmp243 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 1);
    compiler::TNode<Smi> tmp244;
    USE(tmp244);
    tmp244 = CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp239}, compiler::TNode<Smi>{tmp243});
    compiler::TNode<Object> tmp245;
    USE(tmp245);
    tmp245 = UnsafeCast20UT5ATSmi10HeapObject_183(state_, compiler::TNode<Object>{tmp242});
    StoreFixedArrayDirect_190(state_, compiler::TNode<FixedArray>{tmp240}, compiler::TNode<Smi>{tmp239}, compiler::TNode<Object>{tmp245});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 97);
  ...
  if (block19.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp259;
    USE(tmp259);
    tmp259 = FromConstexpr8ATintptr17ATconstexpr_int31_123(state_, 1);
...
void FastSplice16FixedDoubleArray20UT5ATSmi10HeapNumber_1394(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, TorqueStructArguments p_args, compiler::TNode<JSArray> p_a, compiler::TNode<Smi> p_length, compiler::TNode<Smi> p_newLength, compiler::TNode<Smi> p_actualStart, compiler::TNode<Smi> p_insertCount, compiler::TNode<Smi> p_actualDeleteCount) {
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    tmp42 = UnsafeCast16FixedDoubleArray_1372(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 68);
    DoMoveElements16FixedDoubleArray_1440(state_, compiler::TNode<FixedDoubleArray>{tmp42}, compiler::TNode<Smi>{tmp39}, compiler::TNode<Smi>{tmp40}, compiler::TNode<Smi>{tmp41});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 71);
    compiler::TNode<FixedDoubleArray> tmp43;
    USE(tmp43);
    tmp43 = UnsafeCast16FixedDoubleArray_1372(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 70);
    StoreHoles16FixedDoubleArray_1441(state_, compiler::TNode<FixedDoubleArray>{tmp43}, compiler::TNode<Smi>{tmp34}, compiler::TNode<Smi>{tmp33});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 66);
    ca_.Goto(&block6, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41);
  }
  ...
  if (block9.is_used()) {
    ...
    USE(tmp90);
    tmp90 = UnsafeCast16FixedDoubleArray_1372(state_, compiler::TNode<Context>{tmp76}, compiler::TNode<Object>{tmp86});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 75);
    DoMoveElements16FixedDoubleArray_1440(state_, compiler::TNode<FixedDoubleArray>{tmp90}, compiler::TNode<Smi>{tmp87}, compiler::TNode<Smi>{tmp88}, compiler::TNode<Smi>{tmp89});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 74);
    ca_.Goto(&block11, tmp76, tmp77, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83, tmp84, tmp85, tmp86, tmp87, tmp88, tmp89);
  }
  ...
  if (block12.is_used()) {
    ...
    USE(tmp129);
    tmp129 = UnsafeCast16FixedDoubleArray_1372(state_, compiler::TNode<Context>{tmp113}, compiler::TNode<Object>{tmp123});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 86);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 84);
    DoCopyElements16FixedDoubleArray_1442(state_, compiler::TNode<FixedDoubleArray>{tmp128}, compiler::TNode<Smi>{tmp124}, compiler::TNode<FixedDoubleArray>{tmp129}, compiler::TNode<Smi>{tmp125}, compiler::TNode<Smi>{tmp126});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 83);
    ca_.Goto(&block13, tmp113, tmp114, tmp115, tmp116, tmp117, tmp118, tmp119, tmp120, tmp121, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp128);
  }
  ...
  if (block14.is_used()) {
    ...
    USE(tmp213);
    tmp213 = UnsafeCast16FixedDoubleArray_1372(state_, compiler::TNode<Context>{tmp200}, compiler::TNode<Object>{tmp212});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 95);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 97);
    compiler::TNode<IntPtrT> tmp214;
    USE(tmp214);
  ...
  if (block16.is_used()) {
    ...
    USE(tmp245);
    tmp245 = UnsafeCast20UT5ATSmi10HeapNumber_1443(state_, compiler::TNode<Context>{tmp229}, compiler::TNode<Object>{tmp242});
    StoreFixedDoubleArrayDirect_189(state_, compiler::TNode<FixedDoubleArray>{tmp240}, compiler::TNode<Smi>{tmp239}, compiler::TNode<Number>{tmp245});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 97);
    ca_.Goto(&block19, tmp229, tmp230, tmp231, tmp232, tmp233, tmp234, tmp235, tmp236, tmp237, tmp238, tmp244, tmp240, tmp241);
  }
...
void DoMoveElements10FixedArray_1437(compiler::CodeAssemblerState* state_, compiler::TNode<FixedArray> p_elements, compiler::TNode<Smi> p_dstIndex, compiler::TNode<Smi> p_srcIndex, compiler::TNode<Smi> p_count) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp1});
    compiler::TNode<IntPtrT> tmp5;
    USE(tmp5);
    tmp5 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp2});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 36);
    compiler::TNode<IntPtrT> tmp6;
    USE(tmp6);
    tmp6 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp3});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 34);
    TorqueMoveElements_205(state_, compiler::TNode<FixedArray>{tmp0}, compiler::TNode<IntPtrT>{tmp4}, compiler::TNode<IntPtrT>{tmp5}, compiler::TNode<IntPtrT>{tmp6});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 68);
...
void StoreHoles10FixedArray_1438(compiler::CodeAssemblerState* state_, compiler::TNode<FixedArray> p_elements, compiler::TNode<Smi> p_holeStartIndex, compiler::TNode<Smi> p_holeEndIndex) {
  ...
  if (block2.is_used()) {
    ...
    StoreArrayHole_56(state_, compiler::TNode<FixedArray>{tmp8}, compiler::TNode<Smi>{tmp11});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 41);
...
void DoCopyElements10FixedArray_1439(compiler::CodeAssemblerState* state_, compiler::TNode<FixedArray> p_dstElements, compiler::TNode<Smi> p_dstIndex, compiler::TNode<FixedArray> p_srcElements, compiler::TNode<Smi> p_srcIndex, compiler::TNode<Smi> p_count) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp5;
    USE(tmp5);
    tmp5 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp1});
    ...
    compiler::TNode<IntPtrT> tmp7;
    USE(tmp7);
    tmp7 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp4});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 49);
    TorqueCopyElements_207(state_, compiler::TNode<FixedArray>{tmp0}, compiler::TNode<IntPtrT>{tmp5}, compiler::TNode<FixedArray>{tmp2}, compiler::TNode<IntPtrT>{tmp6}, compiler::TNode<IntPtrT>{tmp7});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 84);
...
void DoMoveElements16FixedDoubleArray_1440(compiler::CodeAssemblerState* state_, compiler::TNode<FixedDoubleArray> p_elements, compiler::TNode<Smi> p_dstIndex, compiler::TNode<Smi> p_srcIndex, compiler::TNode<Smi> p_count) {
  ...
  if (block0.is_used()) {
    ...
    tmp6 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp3});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 34);
    TorqueMoveElements_206(state_, compiler::TNode<FixedDoubleArray>{tmp0}, compiler::TNode<IntPtrT>{tmp4}, compiler::TNode<IntPtrT>{tmp5}, compiler::TNode<IntPtrT>{tmp6});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 68);
    ca_.Goto(&block1, tmp0, tmp1, tmp2, tmp3);
  }
...
void StoreHoles16FixedDoubleArray_1441(compiler::CodeAssemblerState* state_, compiler::TNode<FixedDoubleArray> p_elements, compiler::TNode<Smi> p_holeStartIndex, compiler::TNode<Smi> p_holeEndIndex) {
  ...
  if (block2.is_used()) {
    ...
    ca_.Bind(&block2, &tmp8, &tmp9, &tmp10, &tmp11);
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 42);
    StoreArrayHole_55(state_, compiler::TNode<FixedDoubleArray>{tmp8}, compiler::TNode<Smi>{tmp11});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 41);
    ca_.Goto(&block5, tmp8, tmp9, tmp10, tmp11);
  }
...
void DoCopyElements16FixedDoubleArray_1442(compiler::CodeAssemblerState* state_, compiler::TNode<FixedDoubleArray> p_dstElements, compiler::TNode<Smi> p_dstIndex, compiler::TNode<FixedDoubleArray> p_srcElements, compiler::TNode<Smi> p_srcIndex, compiler::TNode<Smi> p_count) {
  ...
  if (block0.is_used()) {
    ...
    tmp7 = Convert8ATintptr5ATSmi_160(state_, compiler::TNode<Smi>{tmp4});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 49);
    TorqueCopyElements_208(state_, compiler::TNode<FixedDoubleArray>{tmp0}, compiler::TNode<IntPtrT>{tmp5}, compiler::TNode<FixedDoubleArray>{tmp2}, compiler::TNode<IntPtrT>{tmp6}, compiler::TNode<IntPtrT>{tmp7});
    ca_.SetSourcePosition("../../deps/v8/../../deps/v8/src/builtins/array-splice.tq", 84);
    ca_.Goto(&block1, tmp0, tmp1, tmp2, tmp3, tmp4);
  }
