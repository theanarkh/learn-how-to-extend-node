...
TorqueStructKeyValuePair LoadKeyValuePairNoSideEffects_239(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_MayHaveSideEffects) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp15);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp15 = Cast10FixedArray_84(state_, compiler::TNode<HeapObject>{tmp14}, &label0);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp41);
    tmp41 = LoadElementOrUndefined_53(state_, compiler::TNode<FixedArray>{tmp39}, compiler::TNode<Smi>{tmp40});
  ...
  if (block13.is_used()) {
    ...
    USE(tmp66);
    tmp66 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 1);
  ...
  if (block15.is_used()) {
    ...
    USE(tmp77);
    tmp77 = LoadElementOrUndefined_53(state_, compiler::TNode<FixedArray>{tmp74}, compiler::TNode<Smi>{tmp76});
  ...
  if (block8.is_used()) {
    ...
    USE(tmp111);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp111 = Cast16FixedDoubleArray_85(state_, compiler::TNode<HeapObject>{ca_.UncheckedCast<FixedArrayBase>(tmp110)}, &label0);
  ...
  if (block21.is_used()) {
    ...
    USE(tmp127);
    tmp127 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 0);
  ...
  if (block23.is_used()) {
    ...
    USE(tmp137);
    tmp137 = LoadElementOrUndefined_54(state_, compiler::TNode<FixedDoubleArray>{tmp135}, compiler::TNode<Smi>{tmp136});
  ...
  if (block25.is_used()) {
    ...
    USE(tmp162);
    tmp162 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 1);
  ...
  if (block27.is_used()) {
    ...
    USE(tmp172);
    tmp172 = FromConstexpr5ATSmi17ATconstexpr_int31_127(state_, 1);
    compiler::TNode<Object> tmp173;
    USE(tmp173);
    tmp173 = LoadElementOrUndefined_54(state_, compiler::TNode<FixedDoubleArray>{tmp170}, compiler::TNode<Smi>{tmp172});
  ...
  if (block4.is_used()) {
    ...
    USE(tmp210);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp210 = Cast10JSReceiver_1365(state_, compiler::TNode<Context>{tmp207}, compiler::TNode<Object>{ca_.UncheckedCast<Object>(tmp209)}, &label0);
...
TorqueStructKeyValuePair LoadKeyValuePair_240(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    compiler::CodeAssemblerLabel label0(&ca_);
    std::tie(tmp2, tmp3) = LoadKeyValuePairNoSideEffects_239(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0).Flatten();
  ...
  if (block3.is_used()) {
    ...
    USE(tmp14);
    tmp14 = Convert5ATSmi17ATconstexpr_int31_1367(state_, 0);
    ...
    USE(tmp16);
    tmp16 = Convert5ATSmi17ATconstexpr_int31_1367(state_, 1);
    compiler::TNode<Object> tmp17;
    USE(tmp17);
