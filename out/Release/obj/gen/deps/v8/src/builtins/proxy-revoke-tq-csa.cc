...
TF_BUILTIN(ProxyRevoke, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp1);
    tmp1 = FromConstexpr13ATContextSlot23ATconstexpr_ContextSlot_145(state_, Context::MIN_CONTEXT_SLOTS);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp10);
    tmp10 = Null_65(state_);
    compiler::TNode<IntPtrT> tmp11;
    USE(tmp11);
    tmp11 = FromConstexpr13ATContextSlot23ATconstexpr_ContextSlot_145(state_, Context::MIN_CONTEXT_SLOTS);
    ...
    USE(tmp12);
    tmp12 = UnsafeCast7JSProxy_1420(state_, compiler::TNode<Context>{tmp8}, compiler::TNode<Object>{tmp9});
